  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Header Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-[#1a3328] py-12 sm:py-16 md:py-20">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-white mb-3 sm:mb-4">
              Contact Us
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
              We're Here to Help. Have a question about an offer, partnership,
              or your account?
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div className="bg-card border rounded-2xl p-5 sm:p-6 lg:p-8 shadow-sm">
                  <div className="mb-6 sm:mb-8">
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base">
                      Please fill out the form below, and our support team will
              ...
              <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          <a
                            href="mailto:partners@offerus.lk"
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li>
                        <Link
                          href="/faq#become-partner"
                          className="text-primary hover:underline flex items-center gap-2"
                        >
                          <FileText className="w-3 h-3" /> How to become a
                          partner
                        </Link>
                      </li>
                      <li>
                        <Link
                          ...
                          className="text-primary hover:underline flex items-center gap-2"
                        >
                          <FileText className="w-3 h-3" /> How offer approval
                          works
                        </Link>
                      </li>
                      <li>
                ...
                <div className="bg-primary/5 rounded-lg p-6 border border-primary/20">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    If you're a business owner interested in promoting your
                    offers through OfferUs:
                  </p>
                  <div className="space-y-2">
            ...
            <div className="mt-12 text-center border-t pt-8">
              ...
              <p className="text-xs text-muted-foreground max-w-xl mx-auto">
                We only use your details to handle your request. Read more in
                our{" "}
